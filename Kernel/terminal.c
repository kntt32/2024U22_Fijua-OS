...
sintn Terminal_Syscall_DrawChar(in uintn layerId, in uintn x, in uintn y, ascii asciicode, Graphic_Color color);
...
sintn terminal_main(void) {
    ...
    Terminal_Syscall_DrawChar(newWindowId, 10, 10, 'A', color);
